...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-white  shadow dark:bg-gray-900 ">
      ...
      <span className="block text-sm pb-6 text-gray-500 text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Dharam_GFX</a>. All Rights Reserved.</span>
    </footer>
  )
}
